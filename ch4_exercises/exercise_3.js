...
and creates a new list that adds the element to the front of the input list, and nth, which takes a list and a number and returns the element at the given 
...
function arrayToList(array){
    ...
    for (let i = 0; i < reversedArray.length; i++){
        let value = reversedArray[i]
        if (i == 0) list = {value:value, rest:null}
...
console.log(listToArray(arrayToList([10, 30])));
// → [10, 20, 30]
